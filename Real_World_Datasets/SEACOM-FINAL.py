...
if __name__ == "__main__":
    ...
    X_train, X_test, Y_train, Y_test = train_test_split(
        X, y, test_size=0.2, random_state=2944
    )
    ...
    filename = f"WaterPotability_CM_Exist_{result}.txt"
    ...
    AC_records,AC_score,AC_time=active_clean_driver(df_train ,df_test)
